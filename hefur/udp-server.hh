...
public:
    ...
    */
   bool start(uint16_t port, bool ipv6);
...
private:
   ...
   void handleConnect(ConnectRequest *conn, size_t size, struct ::sockaddr *addr,
                      socklen_t addr_len);

   void handleAnnounce(AnnounceRequest *ann, size_t size, struct ::sockaddr *addr,
                       socklen_t addr_len);

   void handleScrape(ScrapeRequest *scrape, size_t size, struct ::sockaddr *addr,
                     socklen_t addr_len);

   void sendFailure(ConnectRequest *conn, struct ::sockaddr *addr, socklen_t addr_len,
